...
public class QuoteUtilsTest {
    ...
    @Test
    public void addQuote_clickSave_cancel_editQuote_deleteQuote() {
        ...
        guiTest.waitUntil("#addQuote", visible());
        guiTest.click("#addQuote");
        ...
        guiTest.click("#saveQuote");

        guiTest.click("#addQuote");
        guiTest.click("#cancel");

        guiTest.waitUntil("#quoteTable", visible());
        guiTest.click("#quoteTable");
        p = MouseInfo.getPointerInfo().getLocation();
        guiTest.move(p.x, p.y - 20);
        guiTest.click(MouseButton.PRIMARY);
        FxAssert.verifyThat(new FxRobot().window("Редактирование цитаты"), WindowMatchers.isShowing());
        guiTest.click("#updateQuote");
